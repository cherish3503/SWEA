			...
			for(int i=0; i<cmdN; ++i) {
				...
				switch(cmd) {
					case 'I':
						...
						break;
					case 'D':
						int idxDel = Integer.parseInt(st.nextToken());
						int cntDel = Integer.parseInt(st.nextToken());
						Iterator<Integer> it = cert.listIterator(idxDel);
